...
- Once we've carried out group-wise operations and perhaps reshaped it, we may also like to describe the relationships in the data. Often this involves fitting some style of regression model, or a more complicated statistical or machine learning model.  The goal can be pure prediction, description, or inferring a causal relationship between variables.

Of course to infer causality, one has to be quite careful and techniques that try to avoid the usual pitfall that correlation is not causation are well beyond what we can cover here.
...
# Regression: quick quiz

**[P](https://www.polleverywhere.com/multiple_choice_polls/qgHSSe4LA4okQxca0DbKB)OLL 8A**:

Consider this regression model. What kind of variable should 'year' be?
...
- When we store this regression in an object, we get access to several items of interest, as will generally be the case from fitting any statistical/machine learning model.
...
**[P](https://www.polleverywhere.com/multiple_choice_polls/76o1jRheyV9WsT6EkRk5Z)OLL 8B** Suppose you see this syntax when using the output of a regression:
...
# Distributions: quick quiz

**[P](https://www.polleverywhere.com/multiple_choice_polls/DzwNrFy34BkV0XUO51QGx)OLL 8C**:  Suppose you want know the probability of getting 4 or fewer heads when flipping a coin 10 times. Which of the following will work?
