...
slotNames(fm1)
# fm1$theta  # Incorrect syntax.
fm1@theta    # Correct syntax.
```
...
**[P](https://www.polleverywhere.com/multiple_choice_polls/2vkJnF6GHR8sBUy8UwRiy)OLL 10A**:
...
**[P](https://www.polleverywhere.com/multiple_choice_polls/ixNKbM36rU3WzaFM0TTyT)OLL 10B**: Have you used R's parallel processing capabilities?
...
For option 1, see my [tutorial on the future package (and also Python's dask package)](https://berkeley-scf.github.io/tutorial-dask-future/R-future) for syntax and more details.

For options 4, see my [general tutorial on parallel computing](https://berkeley-scf.github.io/tutorial-parallelization/parallel-R#44-using-multiple-machines-or-cluster-nodes) for syntax and more details. 
