...
**[P](https://www.polleverywhere.com/multiple_choice_polls/uBi9jJwqk3A4YCMJx1UNb)OLL 9A**: Suppose you have a CSV file with one million rows and one thousand columns, filled with numbers. How much memory will this take up if you read the data into R?
...
- RStudio's built-in editor
- Mac: Aquamacs, TextMate, TextEdit
- Windows: WinEdt
- Linux: vim, Emacs with ESS, Atom
...
Please fill out the [feedback survey](https://forms.gle/xh6omJqMYciY3KNP8). See the Ed Discussion board for the link.
