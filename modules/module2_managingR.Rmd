...
**[P](https://www.polleverywhere.com/multiple_choice_polls/K8NRn7KetenA0wkFK6n6c)OLL 2A**: Which of these is true about the gapminder object in R?
...
curl https://cran.r-project.org/src/contrib/fields_14.1.tar.gz \
     -o fields_14.1.tar.gz
tar -xvzf fields_14.1.tar.gz
cd fields
ls R
ls src
ls man
...
setwd('~/Desktop/r-bootcamp-fall-2023') # change the working directory
setwd('/Users/paciorek/Desktop') # absolute path
getwd()
setwd('r-bootcamp-fall-2023/modules') # relative path
...
# setwd('C:\\Users\\Your_username\\Desktop\\r-bootcamp-fall-2023')
# setwd('..\\r-bootcamp-fall-2023')

## Changing the working directory (platform-agnostic)
setwd(file.path('~', 'Desktop', 'r-bootcamp-fall-2023', 'modules')) # change the working directory
setwd(file.path('/', 'Users', 'paciorek', 'Desktop', 'r-bootcamp-fall-2023', 'modules')) # absolute path
getwd()
...
**[P](https://www.polleverywhere.com/multiple_choice_polls/2t5009xR83yX3Tzp5schp)OLL 2B**:
...
1) setwd('Users/paciorek/Desktop/r-bootcamp-fall-2023/data')
2) setwd('/Users/paciorek/Desktop/r-bootcamp-fall-2023/data')
3) setwd('data')
4) setwd('../data')
5) setwd('~paciorek/Desktop/r-bootcamp-fall-2023/data')
6) setwd('paciorek', 'Desktop/r-bootcamp-fall-2023/data')
7) setwd('./data')
8) setwd('Desktop/r-bootcamp-fall-2023/data')


**[P](https://www.polleverywhere.com/multiple_choice_polls/bfvk2xcxBma160uubRaos)OLL 2C**:

Suppose my current working directory is:

`/Users/paciorek/Desktop/r-bootcamp-fall-2023/modules`.

Windows users, just think of this as being:
`C:\Users\paciorek\Desktop\r-bootcamp-fall-2023\modules`.
...
We'll go through a short example of making changes to the r-bootcamp-fall-2023 repository. In this case you don't have permission to make changes so you'll just have to follow along as I do it. However, you could start your own repository and then you'd be able to do similar things.
...
I've had good luck translating between R and Python using ChatGPT.

Another good use case for ChatGPT is asking how to do basic operations when you don't know the name of the function in R.

Of course given ChatGPT's well-known over-optimism, you should always check carefully that the code it provides works as expected.
