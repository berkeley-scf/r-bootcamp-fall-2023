...
We have an [Ed Discussion site](https://edstem.org/us/courses/24442) for discussion and answering questions online during (and before) the bootcamp. 
...
# Getting help
 ...
 - Counselors will be available to help answer any questions you have (just wave to one of them if you're in person).
...
Your counseloRs are: Will Torous (Statistics), Austin Zane (Statistics), and TBD.
...
If you don't want to bother using Git or have problems, simply download a zip file with all the material from [https://github.com/berkeley-scf/r-bootcamp-fall-2023/archive/main.zip](https://github.com/berkeley-scf/r-bootcamp-fall-2023/archive/main.zip).
